...
def extract_text_from_image(image_path: str) -> str:
    ...
    cfg = get_config()
    client = bedrock._client(cfg.region, cfg.read_timeout_sec)
    resp = client.converse(
        ...
        inferenceConfig={"maxTokens": cfg.max_tokens_vision},
    )
    blocks = resp["output"]["message"]["content"]
    extracted = "".join(b["text"] for b in blocks if "text" in b)
